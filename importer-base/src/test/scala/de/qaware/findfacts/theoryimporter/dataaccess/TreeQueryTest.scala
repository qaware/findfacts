package de.qaware.findfacts.theoryimporter.dataaccess

import scala.language.implicitConversions

import de.qaware.findfacts.theoryimporter.dataaccess.treequery.QueryDsl.{all => tAll, not => tNot, of => tOf, _}
import de.qaware.findfacts.theoryimporter.dataaccess.treequery.{FilterQuery, Node, QueryException}
